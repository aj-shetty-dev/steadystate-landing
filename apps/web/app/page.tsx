  ...
  return (
    <main className="min-h-screen bg-bg text-text">
      ...
      <section className="px-4 sm:px-6 lg:px-8 py-16 sm:py-24 max-w-4xl mx-auto">
        ...
        <p className="mt-4 sm:mt-6 text-base sm:text-lg text-text2">
      ...
      <section className="px-4 sm:px-6 lg:px-8 py-12 sm:py-16 max-w-5xl mx-auto grid gap-6 sm:gap-8 md:grid-cols-3">
        {[
      ...
      <footer className="border-t border-border px-4 sm:px-6 lg:px-8 py-4 sm:py-6 text-sm text-text3">
