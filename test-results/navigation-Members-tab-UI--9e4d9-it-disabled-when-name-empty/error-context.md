...
- Name: navigation.spec.ts >> Members tab UI >> Add Member form — submit disabled when name empty
- Location: e2e/browser/navigation.spec.ts:51:7
...
Call log:
  - waiting for getByText('Add Member')
