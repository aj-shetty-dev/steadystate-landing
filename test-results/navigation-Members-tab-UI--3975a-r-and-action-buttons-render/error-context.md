...
- Name: navigation.spec.ts >> Members tab UI >> page header and action buttons render
- Location: e2e/browser/navigation.spec.ts:36:7
...
Locator: getByText('Members')
Expected: visible
Error: strict mode violation: getByText('Members') resolved to 4 elements:
    1) <span class="truncate">Members</span> aka getByRole('link', { name: 'Members', exact: true })
    2) <span class="truncate">Memberships</span> aka getByRole('link', { name: 'Memberships' })
    3) <span class="truncate">Members</span> aka getByText('Members').nth(2)
    4) <span class="truncate">Memberships</span> aka getByText('Memberships').nth(1)

Call log:
  - Expect "toBeVisible" with timeout 5000ms
  - waiting for getByText('Members')
